...
export function Input({ backgroundColor, padding, name, placeholder, type, value, height, width, checked, fontSize, onChange }: propsInput) {
  return (
    ...
    <input
      ...
      style={{ backgroundColor, height, width, fontSize, padding }}
    ></input>
